  ...
  return (
    <>
      ...
      <div className='flex w-full justify-start bg-black'>
        <h1 className='text-2xl text-white pl-44 ml-2'><strong>Trending now</strong></h1>
      </div>
        ...
        {tvShows.slice(0, 9).map(tvShow => (
          <SwiperSlide key={tvShow.id}>
            <div className='h-auto w-4/6 rounded-lg flex-col mt-4 m-6 mb-12 relative inline-block group'>
              ...
              <div class="absolute inset-0 flex items-center justify-center w-full h-full opacity-0 transition duration-500 ease-in-out group-hover:opacity-100">
              </div>
              </Link>
            </div>
          </SwiperSlide>
